...
# 2) FB distribution, the synthetic data which already generated based on
#     the distribution of the Facabook data would be loaded.
...
class SyntheticDataLoader(Dataset):
...
def data_loader(args, ln_emb, m_den):
    data_gens = {"random": make_random_data_and_loader,
                 "fb_synthetic": synthetic_data_loader,
    }
