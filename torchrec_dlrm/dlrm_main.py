...
def parse_args(argv: List[str]) -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Path to a folder containing the binary (npz) files for the MLPerf v2 synthetic multi-hot dataset.",
    )
    parser.add_argument(
        "--learning_rate",
        type=float,
...
def main(argv: List[str]) -> None:
    ...
    assert(args.in_memory_binary_criteo_path is None or args.synthetic_multi_hot_criteo_path is None
